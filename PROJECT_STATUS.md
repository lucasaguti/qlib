...
**Repository baseline:** Qlib checkout at `0ffc0b84`

**Current phase:** development-only daily feature artifact complete; monthly sampling not started
...
3. Define and test month-end sampling, forecast issuance, and three-calendar-month target maturity orchestration.
