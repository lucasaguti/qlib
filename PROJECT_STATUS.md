...
**Current phase:** development-only canonical panel and feature pipeline
...
1. Build the locked eight-feature status layer on the canonical panel, including indicator resets after missing or invalid prices.
