...
| TARGET-001 | `research/abnb/data/interim/monthly_targets.parquet` | SRC-ABNB-001 (`76a120fb7de4489af1d81735ebe9797f3a335abfd6392a1aca9c24f1fbe3603f`); CAL-XNYS-001; EVAL-PROTOCOL-001 (`dd74ed2a387cfa9caab496fcfe12cdcda58b8a1bcdf689b009e20da0ec2b154c`) | `pipeline/targets.py` schema v1; exact adjusted reference/maturity closes; three-calendar-month return; status-bearing availability; final-test withholding; `exchange-calendars==4.13.2`; `pyarrow==23.0.1` | Git `6806a3000d160551114c9c93ea47390a1dd6c4a4`; dirty worktree recorded in artifact | 69 origins: 54 valid development labels, 12 final-test labels withheld, 3 post-test labels immature; price read ends 2025-08-29 | `a01fe17a3788a3df35e186b7acc93d19b465b96a53b85265af197122e6d6a453` | Completed; development-only; untracked; no final-test target access |
| DIAG-DEV-FEATURES-001 | `research/abnb/diagnostics/development_features/artifact_manifest.json` | MONTH-001 (`7c774c32f4fd9a0582968bbef7a16cdacf796c583a301613df4e2b2aff4c7581`); TARGET-001 (`a01fe17a3788a3df35e186b7acc93d19b465b96a53b85265af197122e6d6a453`); EVAL-PROTOCOL-001 (`dd74ed2a387cfa9caab496fcfe12cdcda58b8a1bcdf689b009e20da0ec2b154c`); registered raw sources | `pipeline/feature_diagnostics.py` schema v1; filtered development-only Arrow scans; three fixed 18-origin subperiods; status/distribution/extreme/temporal/correlation/VIF/action/overlap diagnostics; Matplotlib 3.11.2 | Git `fbb869a58beacc4f8a3351771d641f1f2884a728`; dirty worktree recorded in JSON | 54 development origins through 2025-05-30; 42 complete-feature origins; no final-test or post-test rows materialized | `933a6ed70a9311a18fd38e18ee2ff8e9649d3d8254b2cb165ae3cf1abd2255b6` | Completed; development-only; report, strict JSON, and five visually reviewed figures; no final-test access |
| EVAL-DEV-OOS-001 | `research/abnb/evaluation/development_oos/artifact_manifest.json` | MONTH-001 (`7c774c32f4fd9a0582968bbef7a16cdacf796c583a301613df4e2b2aff4c7581`); TARGET-001 (`a01fe17a3788a3df35e186b7acc93d19b465b96a53b85265af197122e6d6a453`); EVAL-PROTOCOL-001 (`dd74ed2a387cfa9caab496fcfe12cdcda58b8a1bcdf689b009e20da0ec2b154c`) | `pipeline/evaluation.py` schema v1; filtered development-only Arrow scans; expanding-window maturity-gated forecasts; fold-local scaling and inner tuning; zero, matured-mean, Ridge, and eight ablations; 10,000-draw paired circular moving-block bootstrap; HAC(2); Holm correction | Git `315469e3b9b4927f8a7a5af0ffd9168689912f5d`; dirty worktree recorded in JSON | 54 scheduled development origins through 2025-05-30; 8 fully eligible scored origins from 2024-10-31 through 2025-05-30; no final-test or post-test rows materialized | `7c59fde299f2efc526d135cbf28334f03ea51fc9419ff88e8053ca44997cfe48` | Completed; development-only pseudo-out-of-sample diagnostic; report and strict JSON tracked, per-origin CSV local/ignored; no final-test access |

## Frozen protocols

| ID | Path | Purpose/version | Frozen scope | SHA-256 | State |
|---|---|---|---|---|---|
| EVAL-PROTOCOL-001 | `research/abnb/config/evaluation_protocol.json` | Machine-readable evaluation protocol, version 1 | Development origins through 2025-05-30; 12 final-test origins from 2025-06-30 through 2026-05-29; post-test origins from 2026-06 quarantined | `dd74ed2a387cfa9caab496fcfe12cdcda58b8a1bcdf689b009e20da0ec2b154c` | Frozen 2026-09-25 before target construction or feature/target analysis; implemented and development-verified; final execution blocked |
